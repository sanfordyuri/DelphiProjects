...
begin
  ...
  SalarioBase := 3000;
  ReturnValue := FDesafio01.calcularIrrf(SalarioBase);
  CheckEquals(95.2, ReturnValue, 'O Resultado não está compatível');
  //CASO FAIXA 3
  SalarioBase := 4000;
  ReturnValue := FDesafio01.calcularIrrf(SalarioBase);
  CheckEquals(263.87, ReturnValue, 'O Resultado não está compatível');
  //CASO FAIXA 4
  SalarioBase := 4664.69;
  ReturnValue := FDesafio01.calcularIrrf(SalarioBase);
  CheckEquals(413.4298, ReturnValue, 'O Resultado não está compatível');
end;
