...
begin
    ...
    case MessageDlg('Confirme que deseja adicionar um novo registro de salário.', TMsgDlgType.mtConfirmation, [TMsgDlgBtn.mbOK, TMsgDlgBtn.mbCancel], 0) of
    mrOk:
      begin
